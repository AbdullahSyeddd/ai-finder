        ...
        <div className="grid lg:grid-cols-12 gap-10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-slate-900/40 border border-emerald-500/20 rounded-2xl p-6 hover:bg-slate-900/60 transition-colors">
                        <h3 className="text-xl font-bold text-emerald-400 mb-4 flex items-center gap-2">
                           <span className="text-2xl">✅</span> The Good
                        </h3>
                    ...
                    <div className="bg-slate-900/40 border border-rose-500/20 rounded-2xl p-6 hover:bg-slate-900/60 transition-colors">
                        <h3 className="text-xl font-bold text-rose-400 mb-4 flex items-center gap-2">
                           <span className="text-2xl">❌</span> The Bad
                        </h3>
                        <ul className="space-y-3">
            ...
            <div className="lg:col-span-4">
                <div className="sticky top-32 space-y-8">
                    ...
                    {/* PRICING WIDGET (Fixed for Object/String) */}
                                ...
                                tool.pricing.map((p, i) => {
                                    ...
                                    return (
                                        <div key={i} className="flex justify-between items-center p-2 rounded bg-slate-800/50 border border-slate-700">
                                            <span className="text-sm font-medium text-white">{isObject ? p.plan : p}</span>
                                            {isObject && <span className="text-xs font-bold text-emerald-400">{p.cost}</span>}
                                        </div>
                                    );
                                })
                            ) : (
                                <p className="text-slate-500 text-sm">Pricing info updating...</p>
                            )}
                        </div>
